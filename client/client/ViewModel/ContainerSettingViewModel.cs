...
namespace wms.Client.ViewModel
{
    ...
    public class ContainerSettingViewModel : ViewModelBase
    {
      ...
      //  private readonly IDeviceAlarmContract DeviceAlarmContract;
        ...
        private bool _TakeInTrayInputEnabled = true;
        ...
        #region 整理存储空间
        private RelayCommand _OrganizeNextCommand;

        public RelayCommand OrganizeNextCommand
        {
            get
            {
                if (_OrganizeNextCommand == null)
                {
                    _OrganizeNextCommand = new RelayCommand(() => OrganizeNext());
                }
                return _OrganizeNextCommand;
            }
        }
