...
namespace wms.Client.Common
{
  ...
  //      /// 设置时间参数
  //      /// </summary>
  //      /// <param name="lUserID">[in] NET_DVR_Login或NET_DVR_Login_V30的返回值</param>
  //      /// <param name="dwCommand">[in] 设备配置命令，详见“Remarks”说明</param>
  //      /// <param name="lChannel">[in] 通道号，不同的命令对应不同的取值，如果该参数无效则置为0xFFFFFFFF即可，详见“Remarks”说明</param>
  //      /// <param name="lpInBuffer">[in] 输入数据的缓冲指针</param>
  //      /// <param name="dwInBufferSize">[in] 输入数据的缓冲长度(以字节为单位) </param>
  //      /// <returns>TRUE表示成功，FALSE表示失败，获取错误码调用NET_DVR_GetLastError</returns>
  //      [DllImport("HCNetSDK.dll", EntryPoint = "NET_DVR_SetDVRConfig")]
  //      public static extern bool NET_DVR_SetDVRConfig(Int32 lUserID, UInt32 dwCommand, Int32 lChannel, NET_DVR_TIME lpInBuffer, Int32 dwInBufferSize);
  ...
  //      public static extern bool NET_DVR_Logout_V30(Int32 lUserID);
        ...
        //// [DllImport("HCNetSDK.dll", EntryPoint = "fRemoteConfigCallback")]
        //public delegate void fRemoteConfigCallback(Int32 dwType, ref NET_DVR_CARD_CFG_COND lpBuffer, Int32 dwBufLen, ref IntPtr pUserData);
        ...
        public struct NET_DVR_CARD_CFG
        {
            ...
            public byte byCardType; //卡类型，1-普通卡，2-残疾人卡，3-黑名单卡，4-巡更卡，5-胁迫卡，6-超级卡，7-来宾卡，默认普通卡
     ...
     //   public static extern int NET_DVR_StartRemoteConfig(int lUserID, uint dwCommand, IntPtr lpInBuffer, Int32 dwInBufferLen, RemoteConfigCallback cbStateCallback, IntPtr pUserData);
       ...
       // public delegate void fRemoteConfigCallback(Int32 dwType, NET_DVR_CARD_CFG lpBuffer, Int32 dwBufLen, IntPtr pUserData);

        /// <summary>
        /// 发送长连接数据。
        /// </summary>
        /// <param name="lHandle">[in] 长连接句柄，NET_DVR_StartRemoteConfig的返回值</param>
        /// <param name="dwDataType">[in] 数据类型，跟长连接接口NET_DVR_StartRemoteConfig的命令参数（dwCommand）有关，详见“Remarks”说明</param>
        /// <param name="pSendBuf">[in] 保存发送数据的缓冲区，与dwDataType有关，详见“Remarks”说明</param>
        /// <param name="dwBufSize">[in] 发送数据的长度</param>
        /// <returns>TRUE表示成功，FALSE表示失败。获取错误码调用NET_DVR_GetLastError</returns>
     //   [DllImport("HCNetSDK.dll", EntryPoint = "NET_DVR_SendRemoteConfig")]
        public static extern bool NET_DVR_SendRemoteConfig(Int32 lHandle, Int32 dwDataType, NET_DVR_CARD_CFG pSendBuf, Int32 dwBufSize);

        /// <summary>
        /// 关闭长连接配置接口所创建的句柄，释放资源。
        /// </summary>
        /// <param name="lHandle">[in] 句柄，NET_DVR_StartRemoteConfig的返回值 </param>
        /// <returns>TRUE表示成功，FALSE表示失败。获取错误码调用NET_DVR_GetLastError。</returns>
       // [DllImport("HCNetSDK.dll", EntryPoint = "NET_DVR_StopRemoteConfig")]
