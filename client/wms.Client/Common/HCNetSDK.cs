...
namespace wms.Client.Common
{
    ...
    {
        #region C:\bini\HCNetSDK.dll macro definition
        //macro definition
        #region common use
        ...
        public const int NET_DVR_GET_FACE_PARAM_CFG = 2507;//获取人脸参数
        public const int NET_DVR_SET_FACE_PARAM_CFG = 2508;//设置人脸参数
        ...
        public const int ENUM_ACS_SEND_DATA = 0x3;//下发人脸模板数据
        public const int ENUM_ACS_INTELLIGENT_IDENTITY_DATA = 0x9;//下发人脸图片数据
        ...
        #endregion // C:\bini\HCNetSDK.dll macro definition


        #region C:\bini\HCNetSDK.dll structure definition
        ...
        [StructLayout(LayoutKind.Sequential)]
        public struct NET_DVR_FACE_PARAM_CFG_FACEDATA
        {
        ...
        #endregion //C:\bini\HCNetSDK.dll structure definition

        #region C:\bini\HCNetSDK.dll function definition
        // function definition
        /* The SDK initialization function */
        [DllImport(@"C:\bini\HCNetSDK.dll")]
     ...
     //   [DllImport(@"C:\bini\HCNetSDK.dll")]
        ...
        [DllImport(@"C:\bini\HCNetSDK.dll", EntryPoint = "NET_DVR_SetDVRConfig")]
         ...
         */
      //  [DllImportAttribute(@"C:\bini\HCNetSDK.dll")]
        [DllImport(@"C:\bini\HCNetSDK.dll")]
         ...
         */
       // [DllImport("E:\\bin\\C:\bini\HCNetSDK.dll")]
        [DllImport(@"C:\bini\HCNetSDK.dll")]
        ...
        public struct NET_DVR_DEL_FACE_PARAM_MODE
        {
            ...
            public byte[] uLen;   //联合体长度
        }

        [StructLayoutAttribute(LayoutKind.Sequential)]
        public struct NET_DVR_FACE_PARAM_BYREADER
        {
            public uint dwCardReaderNo;  //按值表示，人脸读卡器编号
