...
namespace wms.Client.LogicCore.Common
{
    ...
    /// 模块组
    /// </summary>
    public class CheckTaskGroup : ViewModelBase
    {
        private int groupid;
        ...
        private ObservableCollection<CheckTaskItem> modules = new ObservableCollection<CheckTaskItem>();
        ...
        /// 子模块集合
        /// </summary>
        public ObservableCollection<CheckTaskItem> Modules
        {
            get { return modules; }
