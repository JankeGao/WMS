...
namespace wms.Client.LogicCore.Common
{
    ...
    /// 模块组
    /// </summary>
    public class InTaskGroup : ViewModelBase
    {
        private int groupid;
        ...
        private ObservableCollection<InTaskItem> modules = new ObservableCollection<InTaskItem>();
        ...
        /// 子模块集合
        /// </summary>
        public ObservableCollection<InTaskItem> Modules
        {
            get { return modules; }
