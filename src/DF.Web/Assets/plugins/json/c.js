window.SINGLE_TAB = "  ";
window.ImgCollapsed = "/Assets/Plugins/json/Collapsed.gif";
window.ImgExpanded = "/Assets/Plugins/json/Expanded.gif";
...
function Process(target, json) {
    ...
    try {
        ...
        $id(target).innerHTML = "<PRE class='CodeContainer'>" + html + "</PRE>";
    } catch (e) {
        alert("JSON数据格式不正确:\n" + e.message);
        $id(target).innerHTML = "";
    }
