...
return;
    ...
    var _13c = $(ul).prev().children("span.fa-folder");
...
_15d.removeClass("fa-file-text").addClass("fa-folder fa-folder-open");
...
node.find(".tree-icon").removeClass("fa-folder").addClass("fa-file-text");
...
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"tree-icon fa fa-file-text "+(item.iconCls?item.iconCls:"")+"\"></span>");
}
}
...
return jq.each(function(){scroll
_38e(this,true);
});
...
var _827={render:function(_828,_829,_82a){
    ...
    //¼¯³ÉmCustomScrollbar
    if ($(_829).hasClass('mCustomScrollbar')) {
        $(_829).find('.mCSB_container').empty().html(this.renderTable(_828, 0, rows, _82a));
    } else {
...
var _945=body.find("tr[node-id=\""+_940+"\"] span.fa-folder");
...
if(_973.hasClass("fa-file-text")){
_973.removeClass("fa-file-text").addClass("fa-folder fa-folder-open");
...
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"tree-icon fa fa-file-text "+(row.iconCls?row.iconCls:"")+"\"></span>");
}
}
...
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
cell.find(".tree-icon").removeClass("fa-folder").addClass("fa-file-text");
