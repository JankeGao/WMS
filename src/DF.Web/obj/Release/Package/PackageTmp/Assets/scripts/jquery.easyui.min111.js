...
var _13b=$(ul).prev().children("span.fa-folder");
...
hit.next().addClass("fa fa-folder-open");
var ul=$(_13f).next();
if(ul.length){
if(opts.animate){
...
_15c.removeClass("fa fa-file-text-o").addClass("fa fa-folder fa fa-folder-open");
...
node.find(".tree-icon").removeClass("fa fa-folder").addClass("fa fa-file-text-o");
...
if(item.state=="closed"){
    ...
    if (item.iconCls) {
        ...
        cc.push("<span class=\"tree-icon fa fa-folder \"></span>");
    }

}else{
if(item.children&&item.children.length){
cc.push("<span class=\"tree-hit tree-expanded\"></span>");
cc.push("<span class=\"tree-icon fa fa-folder fa fa-folder-open "+(item.iconCls?item.iconCls:"")+"\"></span>");
}else{
cc.push("<span class=\"tree-indent\"></span>");
...
if (item.iconCls) {
    ...
    cc.push("<span class=\"tree-icon fa fa-file-text-o\"></span>");
}
}
}
...
_2e1.find(".fa-angle-right").attr("class", "fa fa-angle-down");
},onExpand:function(){
if(_2e0.onExpand){
...
_2e2.find(".fa-angle-down").attr("class", "fa fa-angle-right");
},onCollapse:function(){
if(_2e0.onCollapse){
...
var t = $("<a href=\"javascript:void(0)\"></a>").addClass("fa fa-angle-right fa-angle-down").appendTo(tool);
...
var _8d3=body.find("tr[node-id=\""+_8ce+"\"] span.fa-folder");
...
if(_900.hasClass("fa fa-file-text-o")){
_900.removeClass("fa fa-file-text-o").addClass("fa fa-folder fa fa-folder-open");
...
if(row.children&&row.children.length){
    cc.push("<span class=\"tree-hit tree-expanded\"></span>");
cc.push("<span class=\"tree-icon fa fa-folder fa fa-folder-open " + (row.iconCls ? row.iconCls : "") + "\"></span>");
}else{
cc.push("<span class=\"tree-indent\"></span>");
...
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
cell.find(".tree-icon").removeClass("fa fa-folder").addClass("fa fa-file-text-o");
    ...
    $.extend($.fn.validatebox.defaults.rules, {
        minLength: {
            validator: function (value, param) {
                var vallen = realLength(value);
                return vallen >= param[0];
            },
