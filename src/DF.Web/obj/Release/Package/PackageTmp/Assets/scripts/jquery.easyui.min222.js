...
_15d.removeClass("fa-file-text-o").addClass("fa-folder fa-folder-open");
...
node.find(".tree-icon").removeClass("fa-folder").addClass("fa-file-text-o");
...
if (_973.hasClass("fa-file-text-o")){
    _973.removeClass("fa-file-text-o").addClass("fa-folder fa-folder-open");
...
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
cell.find(".tree-icon").removeClass("fa-folder").addClass("fa-file-text-o");
