  ...
  <div class="view-image">
    <template v-if="editMode">
      <template v-if="imageURL != ''">
        <img style="width:100%;height:100%;" :src="getImg" @dragstart.prevent @dragover.prevent @drop.prevent>
      </template>
  ...
  computed: {
    imageURL: function() {
      if (this.detail.style.url === undefined || this.detail.style.url === '') {
        ...
        console.log(this.detail.style.url)
        // return this.detail.style.url
        return require('../static/office/' + this.detail.style.url)
      }
    },
    getImg: function() {
      console.log(123)
